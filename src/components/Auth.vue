...
<template>
  <div class="centered-container fade-in">
    <div class="standard-card glass">
      ...
      <!-- Email/Password Login (Only for existing users) -->
      <form v-if="!isRegister" @submit.prevent="handleAuth" class="auth-form">
      ...
      <!-- Gmail OAuth Button (Primary for signup, alternative for login) -->
      <button @click="handleOAuthLogin('google')" class="btn-secondary google-btn" :class="{ 'primary-cta': isRegister }">
        ...
        {{ isRegister ? 'Sign up with Google (Get 3 Free Tokens)' : 'Sign in with Google' }}
      </button>
